...
class _$StudentTearOff {
  ...
  _Student call({int? id, String? name, String? email, int? age}) {
    return _Student(
      id: id,
      name: name,
      email: email,
...
class _$_Student extends _Student with DiagnosticableTreeMixin {
  const _$_Student({this.id, this.name, this.email, this.age}) : super._();
...
abstract class _Student extends Student {
  const factory _Student({int? id, String? name, String? email, int? age}) =
      _$_Student;
